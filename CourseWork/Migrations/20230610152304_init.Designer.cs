...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseWork.Infrastructure.Models.LikeOnRecipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseWork.Infrastructure.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseWork.Infrastructure.Models.RecipeBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseWork.Infrastructure.Models.LikeOnRecipe", b =>
                {
                    b.HasOne("CourseWork.Infrastructure.Models.Recipe", "Recipe")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("CourseWork.Infrastructure.Models.Recipe", b =>
                {
                    b.HasOne("CourseWork.Infrastructure.Models.Cart", null)
                        .WithMany("RecipesInCart")
                        .HasForeignKey("CartId");

                    b.HasOne("CourseWork.Infrastructure.Models.RecipeBook", "RecipeBook")
                        .WithMany("Recipes")
